...
// TODO: The small motors seem to be a bit too long, I picked the size specs from all over the place,
// is there some canonical reference?
Nema08 = [
    [NemaModel, 8],
            ...
            difference() {
                ...
                color(stepperAluminum) {
                    difference() {
                        ...
                        translate([side/2, side/2, -extrSize - 0*mm]) {
